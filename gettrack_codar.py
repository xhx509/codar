...
based on codar data, simulates drifter track and plot it
input values: inputfilename
output values:maxlon,minlon,maxlat,minlat,lat and lon
function uses:getcodar_ctl_file,getdrift_raw_range_latlon,getcodar_ctl_id,getdrift_raw,getcodar,gettrack_codar    
"""
